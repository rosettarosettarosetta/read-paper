...
**Feed Forward** 是一个两层的全连接层，第一层的激活函数为 Relu，第二层不使用激活函数，![](<../.gitbook/assets/image (1) (1) (1) (1) (1) (1).png>)
...
<figure><img src="../.gitbook/assets/image (1) (1) (1) (1).png" alt=""><figcaption><p>飞得越高的数值越大</p></figcaption></figure>
